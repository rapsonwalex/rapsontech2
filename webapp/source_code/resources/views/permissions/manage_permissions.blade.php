...
@section('content')
    ...
    <div class="content">
        <h3 class="content-heading"> Manage Permission</h3>
                ...
                <tbody>
                    @foreach ($permissions as $a => $permission)
                        <tr>
                            ...
                            <td class="font-w600">
                                <a href="{{ url('view_permission/' . $permission->id) }}">
                                    {{ $permission->name }}</a>
                            </td>
                            <td class="font-w600">{{ $permission->display_name }}</td>
                            <td class="font-w600"> {{ $permission->description }}</td>
                            <td class="text-center">

                                <a href="{{ url('view_permission/' . $permission->id) }}" class="btn btn-secondary btn-xs"
                                ...
                                <a href="{{ url('edit_permission/' . $permission->id) }}" class="btn btn-secondary btn-xs"
